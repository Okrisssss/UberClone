                              ...
                              if (Build.VERSION.SDK_INT < 23 || ContextCompat.checkSelfPermission(RiderActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                                  ...
                                  if (lastKnownLocation != null) {
                                      ...
                                      if (distanceInMiles < 0.01) {
                                          ...
                                          LatLng driverLoacationLatLng = new LatLng(driverLocation.getLatitude(), driverLocation.getLongitude());
                                          ...
                                          mMap.clear();
                                          markers.add(mMap.addMarker(new MarkerOptions().position(driverLoacationLatLng).title("Driver location")));

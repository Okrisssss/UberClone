...
public class DriverLocationActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout mapLayout = (RelativeLayout) findViewById(R.id.mapRelativLayout);
        ...
        mapLayout.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                LatLng driverLoacation = new LatLng(intent.getDoubleExtra("driverLatitude", 0), intent.getDoubleExtra("driverLongitude", 0));
                ...
                markers.add(mMap.addMarker(new MarkerOptions().position(driverLoacation).title("Your location")));
